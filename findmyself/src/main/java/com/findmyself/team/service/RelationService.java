...
public class RelationService {
    ...
    public String charterTrafficRelation(Long h_code) {
        ...
        if(no == 4) {
            ctrResult = "집값이 낮으면서 교통여건도 좋지 않은 쪽에 속합니다.";
        } else if(no == 2) {
            ctrResult = "집값이 약간 낮으면서 교통여건도 약간 좋지 않은 쪽에 속합니다.";
        } else if(no == 0) {
            ctrResult = "집값이 보통이고 교통여건도 보통인 쪽에 속합니다.";
        } else if(no == 1) {
            ctrResult = "집값이 약간 높으면서 교통여건도 약간 좋은 쪽에 속합니다.";
        } else {
            ctrResult = "집값이 높고 교통여건도 좋은 쪽에 속합니다.";
        }
    ...
    public String genderSafetyRelation(Long h_code) {
        ...
        if(no == 2) {
            gstResult = "남성의 성비가 높고 안전도가 낮은 쪽에 속합니다";
        } else if(no == 0) {
            gstResult = "남성의 성비가 약간 높고 안전도가 약간 낮은 쪽에 속합니다.";
        } else if(no == 4) {
            gstResult = "남녀의 성비가 비슷하고 안전도가 보통인 쪽에 속합니다.";
        } else if(no == 3) {
            gstResult = "여성의 성비가 약간 높고 안전도가 약간 높은 쪽에 속합니다.";
        } else {
            gstResult = "여성의 성비가 높고 안전도가 높은 쪽에 속합니다.";
        }
